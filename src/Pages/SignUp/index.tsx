...
let validationSchema = yup.object().shape({
  ...
  username: yup.string().required('* Digite seu username').lowercase('a'),
  email: yup.string().email('Formato de e-mail invalido !').required('* Digite seu e-mail'),
      ...
      <main className="bg-white min-h-screen flex ">
        ...
        <div className="flex-1 px-6 xl:px-12 pt-8">
          ...
          <form onSubmit={formik.handleSubmit} className="flex flex-col justify-center space-y-5 xl:items-center">
            ...
            <Button type='submit' colorText="white" colorBg="bg-red-200" text="Cadastrar-se" />
